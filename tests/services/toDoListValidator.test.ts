...
describe("Tests to validate the toDoList service", () => {
    ...
    beforeEach(() => {
        ...
        newItem = new ItemModel("Test", itemCreationDate, "Me");
    });
    ...
    it("Test getLastItem", () => {
        const testItem = new ItemModel("Other test", itemCreationDate, "You");
        toDoList.items = new Array(5).fill(newItem);
    ...
    it("updateItemContent should only modify testItem1 content", () => {
        const testItem1 = new ItemModel("Other test", itemCreationDate, "You");
        const testItem2 = new ItemModel("test again", itemCreationDate, "You again");
        toDoList.items = [testItem1, testItem2];

        toDoList.items = toDoListValidatorService.updateItemContent("You", "test", toDoList.items);
        const newTestItem1 = new ItemModel("test", itemCreationDate, "You");
